...
<html lang="ja">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url(<%=rb.getPhoto() %>);">

        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate">
              <h1><%=rb.getName() %></h1>
              <pre><p class="mb-5"><%= rb.getContent() %></p></pre>
              <p><a href="#" class="btn btn-white btn-outline-white">予約する</a></p>
            </div>
          </div>
        </div>
      </div>
